    	...
    	<ul class="nav nav-tabs">
		  ...
		  <c:choose>
			  <c:when test="${memVO.member_no != 999}">
				  ...
				  <li role="presentation" ${group_status==3? 'class="active"':''}><a href="<%=request.getContextPath()%>/group/group.do?action=listMyGroups&member_no=${memVO.member_no}&group_status=3">我的歷史揪團</a></li>
			  </c:when>
			  <c:otherwise>
