...
<title>評分資料新增 - addRating.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>評分資料新增 - addRating.jsp</h3></td><td>
		 <h4><a href="<%=request.getContextPath()%>/front-end/rating/select_rating_page.jsp"><img src="<%=request.getContextPath()%>/images/comment_images/comment1.jpg" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
	<tr>
		...
		<td><input type="TEXT" name="memberno" size="45"
			 value="<%= (ratingVO==null)? "1" : ratingVO.getMemberno()%>" /></td>
	</tr>
	...
	<tr>
		...
		<td><select size="1" name="movieno">
			<c:forEach var="movieVO" items="${movieSvc.all}">
				<option value="${movieVO.movieno}" ${(ratingVO.movieno==movieVO.movieno)? 'selected':'' } >${movieVO.moviename}
			</c:forEach>
		</select></td>
	</tr>
<!-- 	<tr> -->
