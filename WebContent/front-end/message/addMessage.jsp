...
//   上一行為messageVO為null(req.getAttribute取不到會取null)
...
<title>訊息資料新增 - addMessage.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>訊息資料新增 - addMessage.jsp</h3></td><td>
		 <h4><a href="<%=request.getContextPath()%>/front-end/message/select_page.jsp"><img src="<%=request.getContextPath()%>/images/tomcat.png" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<!-- 	<tr> -->
<!-- 		<td>發訊會員編號(請輸入數字，如:1):</td> -->
<%-- 		<td><input type="TEXT" name="from_member_no" size="45" value="<%= (messageVO==null)? "" : messageVO.getFrom_member_no()%>" /></td> --%>
<!-- 	</tr> -->
<!-- 	<tr> -->
<!-- 		<td>收訊會員編號(請輸入數字，如:1)</td> -->
<%-- 		<td><input type="TEXT" name="to_member_no" size="45"	value="<%=(messageVO==null)? "" : messageVO.getTo_member_no()%>" /></td> --%>
<!-- 	</tr> -->
	<tr>
		<td>訊息內容</td>
		<td><input type="TEXT" name="message_content" size="45"	value="<%=(messageVO==null)? "了不起!負責!" : messageVO.getMessage_content()%>" /></td>
	</tr>
<!-- 	<tr> -->
<!-- 		<td>訊息時間</td> -->
