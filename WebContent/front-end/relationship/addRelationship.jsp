...
<title>文章資料新增 - addARelationship.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>員工資料新增 - addRelationship.jsp</h3>
		 <h4><a href="<%=request.getContextPath()%>/front-end/relationship/select_page.jsp"><img src="<%=request.getContextPath()%>/front-end/relationship/images/tomcat.png" width="100" height="32" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
	...
	<tr>
		...
		<td><input type="TEXT" name="member_no" size="45" 
			 value="<%=(relationshipVO==null)? "1" : relationshipVO.getMember_no()%>" /></td>
	</tr>
	<tr>
		<td>會員好友編號:</td>
