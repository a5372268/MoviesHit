...
<table>
	<tr>
		<td>訂單編號</td>
		<td>
			<input type="text" name="order_no" value="${(ord_foodVO==null) ? '1' : ord_foodVO.order_no}">
		</td>
	</tr>
	<tr>
		<td>票種編號</td>
		<td>
			<input type="text" name="food_no" value="${(ord_foodVO==null) ? '1' : ord_foodVO.food_no}">
		</td>
	</tr>
	<tr>
		<td>數量</td>
		<td>
			<input type="text" name="food_count" value="${(ord_foodVO==null) ? '1' : ord_foodVO.food_count}">
		</td>
	</tr>
	<tr>
		<td>價格</td>
		<td>
			<input type="text" name="price" value="${(ord_foodVO==null) ? '100' : ord_foodVO.price}">
		</td>
	</tr>
</table>
<br>
