...
<%-- <% --%>
// // 	Integer showtime_no = (Integer)session.getAttribute("showtime_no");
...
<!-- <title>場次資料修改2 - update_showtime_input2.jsp</title> -->
...
<!-- <table id="table-1"> -->
<!-- 	<tr><td> -->
<!-- 		 <h3>場次資料修改2 - update_showtime_input2.jsp</h3> -->
