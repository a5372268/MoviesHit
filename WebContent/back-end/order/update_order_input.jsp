                                ...
                                <div class="table-responsive">
                                  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/order/order.do" name="form1">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="text-align:left;">
                                        ...
                                        <tbody>
											<tr>
												<td width="110px;"><span style="font-weight:bolder;">會員編號</td>
												<td>
											...
											<tr>
												<td><span style="font-weight:bolder;">場次編號</span></td>
												<td>
											...
											<tr>
												<td><span style="font-weight:bolder;">創建時間</span></td>
												<td>
											...
											<tr>
												<td><span style="font-weight:bolder;" >訂單狀態</span></td>
												<td>
											...
											<tr>
												<td><span style="font-weight:bolder; ">訂單種類</span></td>
												<td>
													<select name="order_type" style="width:189px;">
															<option value= "0" ${(orderVO.order_type == null) ? "" :(orderVO.order_type == 0 ? "selected" : "")}>現場購票</option>
															<option value= "1" ${(orderVO.order_type == null) ? "" :(orderVO.order_type == 1 ? "selected" : "")}>線上購票</option>
													</select>
												</td>
												<td></td> 
											</tr>
											<tr>
												<td><span style="font-weight:bolder;">付款方式</span></td>
												<td>
													<select name="payment_type" style="width:189px;">
															<option value= "0" ${(orderVO.payment_type == null) ? "" :(orderVO.payment_type == 0 ? "selected" : "")}>信用卡</option>
															<option value= "1" ${(orderVO.payment_type == null) ? "" :(orderVO.payment_type == 1 ? "selected" : "")}>現金</option>
													</select>
												</td>
												<td></td> 
											</tr>
											<tr>
												<td><span style="font-weight:bolder;">訂單總價</span></td>
												<td>
											...
											<tr>
												<td><span style="font-weight:bolder;">座位</span></td>
												<td>
