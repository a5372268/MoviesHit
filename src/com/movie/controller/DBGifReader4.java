...
public class DBGifReader4 extends HttpServlet {
	...
	public static final String SQL = "SELECT MOVIE_PIC1 FROM `MOVIE` WHERE MOVIE_NO = ?";
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if (rs.next()) {
				...
				BufferedInputStream in = new BufferedInputStream(rs.getBinaryStream("MOVIE_PIC1"));
				if(in.available() != 0) {
