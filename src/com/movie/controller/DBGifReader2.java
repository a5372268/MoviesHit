...
public class DBGifReader2 extends HttpServlet {
	...
	public static final String SQL = "SELECT MOVIE_PIC2 FROM MOVIE WHERE MOVIE_NO = ?";
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			if (rs.next()) {
				BufferedInputStream in = new BufferedInputStream(rs.getBinaryStream("MOVIE_PIC2"));
